    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
      ...
      <section className="py-8 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
            <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-2xl p-8 md:p-12 text-center text-white relative overflow-hidden">
            <div className="relative z-10">
                <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">Join the BloomEdge Family</h2>
                <p className="mb-8 max-w-xl mx-auto text-green-50">Subscribe to our newsletter for exclusive deals, new arrivals, and healthy living tips.</p>
                <form className="flex flex-col sm:flex-row justify-center max-w-md mx-auto gap-2">
                <input type="email" placeholder="Enter your email" className="w-full px-4 py-3 rounded-lg text-gray-900 border-none focus:ring-2 focus:ring-white" />
                <button type="button" className="bg-gray-900 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors">Subscribe</button>
                </form>
            </div>
            </div>
        </div>
